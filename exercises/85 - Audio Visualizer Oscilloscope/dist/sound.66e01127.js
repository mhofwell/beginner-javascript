...
async function getAudio() {
  ...
  analyzer.fftSize = 2 ** 15; // pull the data off the audio
...
function drawTimeData(timeData) {
  ...
  analyzer.getByteTimeDomainData(timeData); // now that we have data, lets turn it into a visualization
  // 1. clear the canvas TODO

  ctx.clearRect(0, 0, WIDTH, HEIGHT); // 2. set-up canvas drawing
...
getAudio();
},{"./utils.js":"utils.js"}],"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","sound.js"], null)
