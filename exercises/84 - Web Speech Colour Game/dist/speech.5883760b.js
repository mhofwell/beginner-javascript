...
function handleResult({
  ...
  console.log(words); // lowercase everything first

  let color = words.toLowerCase(); // strip any spaces out

  color = color.replace(/\s/g, ''); // check if words are a valid color
  ...
  console.log('valid!'); // change the background color

  document.body.style.backgroundColor = color;
}
},{"./colors.js":"colors.js"}],"speech.js":[function(require,module,exports) {
"use strict";
...
},{"./handlers.js":"handlers.js","./colors.js":"colors.js"}],"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
